...
def _add_agent_session(sub: argparse._SubParsersAction) -> None:
    ...
    run.add_argument(
        ...
        help="combined stdout/stderr hard cap",
    )
...
def _add_agent_factory(sub: argparse._SubParsersAction) -> None:
    ...
    supervise.add_argument("--max-review-tokens", type=int, default=2400)
    supervise.add_argument("--max-calibration-tokens", type=int, default=2400)
...
def _cmd_agent_factory_batch(args: argparse.Namespace) -> int:
    ...
    state = factory_batch_mod.run_batch(
        ...
        max_promotion_review_usd=args.max_promotion_review_usd,
